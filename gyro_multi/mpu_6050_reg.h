#ifndef _MPU_6050_REG_H_
#define _MPU_6050_REG_H_
...
typedef struct last_data_struct
{
    unsigned long read_time;
    float         x_angle;  // These are the filtered angles
    float         y_angle;
    float         z_angle;  
    float         gyro_x_angle;  // Store the gyro angles to compare drift
    float         gyro_y_angle;
    float         gyro_z_angle;
} last_data;

typedef struct base_data_struct
{
    float    x_accel;
    float    y_accel;
    float    z_accel;
